...
export default function Home() {
  return (
    <div className="relative mt-[-121px] h-full pt-8">
      <SlidingAnimation />
      <main className="relative h-full w-full p-5">
        <video
          ...
          muted
          playsInline
          className="max-h-dvh w-full object-cover brightness-75"
        ></video>
        <div className="absolute inset-0 flex h-full items-center justify-center">
          <motion.div
            ...
            className="text-[45px] uppercase tracking-widest text-white"
          >
